    ...
    internal class AccommodationRepository : RepositoryBase, IAccommodationRepository
    {
        public void Add(Accommodation accommodation)
        {
            ...
            const string insertStatement =
                @"insert into Accommodation(name, type, maxGuests, minGuests, locationId, adress, reservableDays, images, description) 
                    values ($name, $type, $maxGuests, $minGuests, $locationId, $adress, $reservableDays, $images, $description)";
            ...
            insertCommand.Parameters.AddWithValue("$maxGuests", accommodation.MaxReservationDays);
            insertCommand.Parameters.AddWithValue("$minGuests", accommodation.MinReservationDays);
